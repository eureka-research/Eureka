...
class ShadowHandScissorsGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("scissor_left_handle", "left_palm")
        self.set_min_l2_distance_reward("scissor_left_handle", "left_thumb")
