...
class ShadowHandBlockStackGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("block2", "block1")
        self.set_min_l2_distance_reward("block2", "left_palm")
        self.set_min_l2_distance_reward("block1", "right_palm")
        self.set_obj_orientation_reward("block2", "block1")
