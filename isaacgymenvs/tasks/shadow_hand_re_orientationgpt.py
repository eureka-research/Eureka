...
class ShadowHandReOrientationGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_max_l2_distance_reward("object1", "object2")
        self.set_min_l2_distance_reward("object1", "left_palm")
        self.set_min_l2_distance_reward("object2", "right_palm")
