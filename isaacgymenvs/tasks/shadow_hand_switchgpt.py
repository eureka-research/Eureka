...
class ShadowHandSwitchGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("left_switch", "right_switch")
        self.set_min_l2_distance_reward("left_palm", "right_switch")
        self.set_min_l2_distance_reward("left_forefinger", "right_switch")
        self.set_min_l2_distance_reward("left_middlefinger", "right_switch")
        self.set_min_l2_distance_reward("left_ringfinger", "right_switch")
        self.set_min_l2_distance_reward("left_littlefinger", "right_switch")
        self.set_min_l2_distance_reward("left_thumb", "right_switch")
        self.set_max_l2_distance_reward("right_switch", "nothing")
