...
class ShadowHandDoorCloseInwardGPT(VecTask):
    ...
    def get_obj_pos_from_name(self, name):
        ...
        elif name in ["object1_goal", "pot_goal", "cup_goal"]:
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("door_left_handle", "left_palm")
        self.set_min_l2_distance_reward("door_left_handle", "left_forefinger")
        self.set_min_l2_distance_reward("door_left_handle", "left_middlefinger")
        self.set_min_l2_distance_reward("door_left_handle", "left_ringfinger")
        self.set_min_l2_distance_reward("door_left_handle", "left_littlefinger")
        self.set_min_l2_distance_reward("door_left_handle", "left_thumb")
