...
class ShadowHandSwingCupGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = self.compute_gpt_reward()
    ...
    ##### End of inserted Bidex reward API #####
    
    def compute_gpt_reward(self):
        self.reward_components = {}
        ##### Insert GPT reward here #####
        self.set_max_l2_distance_reward("cup_left_handle", "cup_goal")
        self.set_max_l2_distance_reward("cup_goal", "cup_right_handle")
        self.set_min_l2_distance_reward("cup_left_handle", "left_palm")
        self.set_min_l2_distance_reward("cup_right_handle", "right_palm")
        self.set_min_l2_distance_reward("cup_left_handle", "left_forefinger")
        self.set_min_l2_distance_reward("cup_left_handle", "left_middlefinger")
        self.set_min_l2_distance_reward("cup_left_handle", "left_ringfinger")
        self.set_min_l2_distance_reward("cup_left_handle", "left_littlefinger")
        self.set_min_l2_distance_reward("cup_left_handle", "left_thumb")
        self.set_min_l2_distance_reward("cup_right_handle", "right_forefinger")
        self.set_min_l2_distance_reward("cup_right_handle", "right_middlefinger")
        self.set_min_l2_distance_reward("cup_right_handle", "right_ringfinger")
        self.set_min_l2_distance_reward("cup_right_handle", "right_littlefinger")
        self.set_min_l2_distance_reward("cup_right_handle", "right_thumb")
        ##### End of inserted GPT reward #####
        total_reward = torch.sum(torch.stack(list(self.reward_components.values())), dim=0)
