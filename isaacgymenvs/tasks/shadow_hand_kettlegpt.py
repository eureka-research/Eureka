...
class ShadowHandKettleGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("kettle_handle", "bucket_handle")
        self.set_obj_orientation_reward("kettle_handle", "bucket_handle")
        self.set_obj_orientation_reward("kettle_handle", "left_palm")
