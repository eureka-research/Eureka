...
class ShadowHandTwoCatchUnderarmGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("object1", "object1_goal")
        self.set_min_l2_distance_reward("object2", "object2_goal")
        self.set_min_l2_distance_reward("left_palm", "object1")
        self.set_min_l2_distance_reward("right_palm", "object2")
        self.set_min_l2_distance_reward("left_forefinger", "object1")
        self.set_min_l2_distance_reward("left_middlefinger", "object1")
        self.set_min_l2_distance_reward("left_ringfinger", "object1")
        self.set_min_l2_distance_reward("left_littlefinger", "object1")
        self.set_min_l2_distance_reward("left_thumb", "object1")
        self.set_min_l2_distance_reward("right_forefinger", "object2")
        self.set_min_l2_distance_reward("right_middlefinger", "object2")
        self.set_min_l2_distance_reward("right_ringfinger", "object2")
        self.set_min_l2_distance_reward("right_littlefinger", "object2")
        self.set_min_l2_distance_reward("right_thumb", "object2")
