...
class ShadowHandPenGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("pen_cap", "pen")
        self.set_min_l2_distance_reward("pen_cap", "left_palm")
        self.set_min_l2_distance_reward("pen_cap", "right_palm")
        self.set_min_l2_distance_reward("pen_cap", "left_forefinger")
        self.set_min_l2_distance_reward("pen_cap", "left_middlefinger")
        self.set_min_l2_distance_reward("pen_cap", "left_ringfinger")
        self.set_min_l2_distance_reward("pen_cap", "left_littlefinger")
        self.set_min_l2_distance_reward("pen_cap", "left_thumb")
        self.set_min_l2_distance_reward("pen_cap", "right_forefinger")
        self.set_min_l2_distance_reward("pen_cap", "right_middlefinger")
        self.set_min_l2_distance_reward("pen_cap", "right_ringfinger")
        self.set_min_l2_distance_reward("pen_cap", "right_littlefinger")
        self.set_min_l2_distance_reward("pen_cap", "right_thumb")
