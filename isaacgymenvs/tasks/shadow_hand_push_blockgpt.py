...
class ShadowHandPushBlockGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_max_l2_distance_reward("block1", "block2")
        self.set_min_l2_distance_reward("left_palm", "block1_goal")
        self.set_min_l2_distance_reward("right_palm", "block2_goal")
        self.set_min_l2_distance_reward("left_forefinger", "block1_goal")
        self.set_min_l2_distance_reward("right_forefinger", "block2_goal")
        self.set_min_l2_distance_reward("left_thumb", "block1_goal")
        self.set_min_l2_distance_reward("right_thumb", "block2_goal")
