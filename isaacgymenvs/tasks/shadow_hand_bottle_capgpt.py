...
class ShadowHandBottleCapGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("bottle_cap", "bottle")
        self.set_min_l2_distance_reward("bottle_cap", "left_palm")
        self.set_min_l2_distance_reward("bottle", "right_palm")
