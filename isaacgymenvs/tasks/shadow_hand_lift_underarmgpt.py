...
class ShadowHandLiftUnderarmGPT(VecTask):
    ...
    def compute_gpt_reward(self):
        ...
        self.set_min_l2_distance_reward("pot_left_handle", "pot_right_handle")
        self.set_min_l2_distance_reward("pot_left_handle", "left_palm")
        self.set_min_l2_distance_reward("pot_right_handle", "right_palm")
