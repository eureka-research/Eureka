...
#         stripped = line.lstrip()
#         if stripped.startswith("def compute_observations("):
#             in_function = True
#             function_indent_level = len(line) - len(stripped)
#         elif in_function and stripped.startswith("return"):
#             current_indent_level = len(line) - len(stripped)
#             if current_indent_level == function_indent_level + 4: # assuming indentation is 4 spaces
#                 end_line = i + 1
#                 break
...
# print(extract_code("tasks/cartpole.py"))